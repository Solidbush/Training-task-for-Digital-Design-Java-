...
* ### **Требования к формату ввода:**
  1. Названия колонок таблицы и строковые значения указываются в одинарных кавычках. (**'**)
  2. Значения полей указываются через **","**.
  3. Поля в условие указываются через логические операторы **or**/**and**.
  4. Команды: **Select**, **Insert**, **Delete**, **Update** - **регистронезависимые.**
  5. Ключевые слова: **Where**, **Values** - **регистронезависимые.**
  6. Логические операторы: **or**, **and**, **like**, **ilike** - **регистрозависимые.**
  7. Названия колонок: **Id**, **lastName**, **cost**, **active**, **age** - **регистронезависимые.**
* ### **Формат ввода команд:**
